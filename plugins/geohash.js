...
export default ({ app }, inject) => {
    ...
    const getGeoHash = function(location, level){   
        console.log("location", location, "level", level)
        const geohash = Geohash.encode(location.coords.latitude, location.coords.longitude, level);
        console.log("geohash", geohash)
        return geohash
  }
  inject('getGeoHash', getGeoHash);
}
